...
<div class="mt-4" x-data="{ showSetujui: false, showTolak: false }">
    ...
    <div class="flex items-center gap-2 text-sm text-gray-500 mb-5">
        <a href="{{ route('admin.usulan.index') }}" class="hover:text-orange-600">Kelola Usulan</a>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                ...
                <div class="grid grid-cols-2 gap-4 mt-4">
                    <div>
                        ...
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium
                            {{ $usulan->kewenangan === 'BKN Pusat' ? 'bg-orange-500 text-white' : 'bg-gray-700 text-white' }}">
                            {{ $usulan->kewenangan }}
                        </span>
                    </div>
                    <div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 mb-3">
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                            ...
                            <div>
                                ...
                                <span class="px-2 py-0.5 bg-orange-100 text-orange-600 rounded text-xs font-medium">{{ $asn->status_pegawai }}</span>
                            </div>
                            <div>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <a href="{{ asset('storage/' . $dok->file_path) }}" target="_blank"
                               class="flex items-center gap-2 bg-white border border-gray-200 hover:border-blue-400 hover:text-orange-600 px-3 py-2 rounded-lg text-xs font-medium transition">
        ...
        <div class="space-y-5">
            ...
            <div class="bg-white rounded-xl shadow-sm p-5">
                ...
                <div class="flex items-center gap-3 mb-4">
                    <div class="w-12 h-12 bg-orange-100 rounded-full flex items-center justify-center font-bold text-orange-600">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 text-xs
                            {{ $idx < $current ? 'bg-green-500 text-white' : ($idx === $current ? 'bg-orange-500 text-white' : 'bg-gray-200 text-gray-400') }}">
                            @if($idx < $current)
                        ...
                        <span class="text-xs {{ $idx === $current ? 'text-orange-600 font-semibold' : ($idx < $current ? 'text-green-600' : 'text-gray-400') }}">
                            {{ $step }}
                        </span>
                    </div>
                    @endforeach
