    ...
    <div class="bg-white rounded-xl shadow-sm p-4 mb-5">
        <form method="GET" class="flex flex-wrap gap-3 items-end">
            ...
            <div class="min-w-40">
                ...
                <select name="tahapan" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500">
            ...
            <div class="min-w-40">
                ...
                <select name="kewenangan" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500">
                    <option value="">Semua</option>
            ...
            <button type="submit" class="bg-orange-500 hover:bg-orange-600 text-white px-5 py-2 rounded-lg text-sm font-medium transition">
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-4">
                            <div class="font-semibold text-orange-600">{{ $u->nomor_surat }}</div>
                        ...
                        <td class="px-4 py-4">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium
                                {{ $u->kewenangan === 'BKN Pusat' ? 'bg-orange-500 text-white' : 'bg-gray-700 text-white' }}">
                                {{ $u->kewenangan }}
                            </span>
                        </td>
                        <td class="px-4 py-4">
                        ...
                        <td class="px-4 py-4 text-center">
                            <a href="{{ route('admin.usulan.show', $u) }}"
                               class="inline-flex items-center gap-1 bg-orange-500 hover:bg-orange-600 text-white px-3 py-1.5 rounded-lg text-xs font-medium transition">
