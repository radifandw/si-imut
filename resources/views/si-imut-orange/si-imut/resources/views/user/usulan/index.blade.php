            ...
            <form method="POST" action="{{ route('user.usulan.store') }}" class="px-6 py-5 space-y-4">
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        <input type="text" name="nomor_surat" x-model="nomorSurat" required
                               class="flex-1 border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
                               placeholder="P/0001/03/D/2026">
                        <button type="button" @click="generateNomor()"
                                :disabled="loading"
                                class="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2.5 rounded-lg text-sm font-medium transition flex items-center gap-2">
                ...
                <div>
                    ...
                    <textarea name="perihal" rows="3" required
                              class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 resize-none"
                ...
                <div class="flex gap-3 pt-2">
                    ...
                    <button type="submit"
                            class="flex-1 bg-orange-500 hover:bg-orange-600 text-white py-2.5 rounded-lg text-sm font-semibold transition shadow">
