    ...
    <form method="POST" action="{{ route('user.berkas.store', $usulan) }}" enctype="multipart/form-data">
        ...
        <div x-show="currentStep === 1" class="bg-white rounded-xl shadow-sm p-6">
            <h3 class="font-bold text-gray-800 mb-5 text-lg flex items-center gap-2">
                <i class="fas fa-user-circle text-orange-600"></i> Langkah 1 — Pilih Prosedur & Data ASN
            </h3>
        ...
        <div x-show="currentStep === 2" class="bg-white rounded-xl shadow-sm p-6">
            <h3 class="font-bold text-gray-800 mb-5 text-lg flex items-center gap-2">
                <i class="fas fa-history text-orange-600"></i> Langkah 2 — Riwayat ASN
            </h3>
            <div class="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-5">
                <p class="text-sm text-orange-600"><i class="fas fa-info-circle mr-2"></i>
        ...
        <div x-show="currentStep === 3" class="bg-white rounded-xl shadow-sm p-6">
            <h3 class="font-bold text-gray-800 mb-5 text-lg flex items-center gap-2">
                <i class="fas fa-paperclip text-orange-600"></i> Langkah 3 — Upload Dokumen
            </h3>
                            ...
                            <div>
                                ...
                                <div class="flex gap-2">
                                    <input type="file" :name="'dokumen[' + index + ']'"
                                           ...
                                           class="flex-1 border border-gray-200 rounded px-3 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-orange-500">
