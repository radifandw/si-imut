    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-16 h-16 bg-white rounded-2xl shadow-lg mb-4">
                <span class="text-blue-700 font-extrabold text-xl">SI</span>
            </div>
            <h1 class="text-white text-2xl font-bold">SI-IMUT</h1>
            <p class="text-blue-200 text-sm mt-1">Sistem Informasi Mutasi ASN</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <form method="POST" action="{{ route('login.post') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" required
                               class="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
                ...
                <button type="submit"
                        class="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 rounded-lg transition text-sm shadow">
            ...
            <div class="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-100">
                ...
                <div class="space-y-2">
                    <div class="flex items-center justify-between text-xs">
                        <span class="text-gray-600"><i class="fas fa-user-shield text-blue-500 mr-1"></i><strong>Admin:</strong></span>
        ...
        <p class="text-center text-blue-200 text-xs mt-6">© {{ date('Y') }} SI-IMUT — Kabupaten</p>
    </div>
</body>
</html>
