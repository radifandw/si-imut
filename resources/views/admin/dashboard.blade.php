...
@section('content')
<div class="mt-4">
    <div class="bg-gradient-to-r from-blue-700 to-blue-900 rounded-2xl p-6 text-white mb-6 shadow">
    ...
    <div class="bg-white rounded-xl shadow-sm">
        <div class="flex items-center justify-between px-6 py-4 border-b">
            ...
            <a href="{{ route('admin.usulan.index') }}" class="text-blue-600 text-sm hover:underline">Lihat semua →</a>
        </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition cursor-pointer" onclick="window.location='{{ route('admin.usulan.show', $u) }}'">
                        <td class="px-4 py-3 font-semibold text-blue-700">{{ $u->nomor_surat }}</td>
