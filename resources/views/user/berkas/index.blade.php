...
<div class="mt-4">
    ...
    <div class="flex items-center gap-2 text-sm text-gray-500 mb-5">
        <a href="{{ route('user.usulan.index') }}" class="hover:text-blue-600 transition">Daftar Usulan</a>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 mb-5">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 flex-1">
                <div>
                    ...
                    <div class="font-bold text-blue-700">{{ $usulan->nomor_surat }}</div>
                </div>
                <div>
        ...
        <div class="mt-4 flex gap-3">
            ...
            <form method="POST" action="{{ route('user.usulan.kirim', $usulan) }}"
                ...
                @csrf
                <button type="submit"
                        class="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg text-sm font-medium shadow transition">
